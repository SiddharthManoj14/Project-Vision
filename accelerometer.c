 ...
 *		If in rapid fire mode, transmit a rapid fire pacekt every 30ms. */
ISR (TIMER0_COMPA_vect)
{
  ...
  // Every other 8ms, transmit the cursor position or scroll message to the base station
	...
	// If move is enabled and scroll is disabled, transmit the cursor position message to the base station
